...
export const getContentById = async(req, res) => {
    try {
        const response = await Background.findOne({
            where:{
                id: req.params.id
            }
        });
...
export const saveContent = (req, res) => {
    ...
    file.mv(`./public/images/${fileName}`, async(err)=>{
        ...
        try {
            await Background.create({name: name, image: fileName, url: url});
...
export const updateContent = async(req, res) => {
    const contenu = await Background.findOne({
        where:{
            id: req.params.id
        }
    });
...
export const deleteContent = async(req, res) => {
    ...
    try{
        const filepath = `./public/images/${contenu.image}`;
        fs.unlinkSync(filepath);
        // app.options('/Background/:id', cors());
